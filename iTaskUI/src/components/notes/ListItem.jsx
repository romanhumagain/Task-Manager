    ...
    <>
      ...
      <Link to={`/note/${props.note.slug}`}>
        <div className="bg-slate-300 rounded shadow-md overflow-hidden">
          <img src={notes} alt='notes-img' className='w-full h-32 sm:48 object-cover'/>
          <div className="card-body p-4">
            
            <span className='font-bold text-neutral-700 text-xl'>{props.note.title}</span>
            <span className='block text-neutral-600 mt-3'>{props.note.body.slice(0,100)} <span className='font-light'>... read more</span></span>
