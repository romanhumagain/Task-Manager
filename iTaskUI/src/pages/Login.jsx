  ...
  return (
    <>
      <div className='flex justify-center items-center h-screen bg-slate-100'>
        <div className='w-96 p-10 shadow-lg bg-neutral-700 rounded-md'>
          ...
          <form onSubmit={loginUser}>
            ...
            <p className='m-2 text-center mt-3'><span className='text-white'>Create a new account?<Link to='/register' className='ml-2 text-blue-500'>Register</Link></span></p>
          </form>
        </div>
      </div>
      <ToastContainer />
